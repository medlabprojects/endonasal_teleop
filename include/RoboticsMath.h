...
namespace RoboticsMath 
{
	...
	Eigen::Vector4d slerp(Eigen::Vector4d qa, Eigen::Vector4d qb, double t);
        ...
        void getCofactor(double A[6][6], double temp[6][6], int p, int q, int n) // TODO: is this used? useful? no return?
        {
        ...
        void inverse(double A[6][6], double inverse[6][6]) // TODO: for loops using best practices?
        {
